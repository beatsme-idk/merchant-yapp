...
echo "For package.json cleanup, please manually edit the file to remove unused dependencies."
echo "Recommended actions:"
echo "1. Remove all @radix-ui/* dependencies except for: react-alert, react-badge, react-button, react-card, react-dialog, react-icons, react-input, react-label, react-progress, react-separator, react-slot"
echo "2. Remove 'tempo-devtools' from devDependencies"
